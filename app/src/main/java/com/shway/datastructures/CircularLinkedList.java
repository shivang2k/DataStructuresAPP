 ...
 */
public class CircularLinkedList extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_circular_linked_list, container, false);
        LinearLayout linearLayout = root.findViewById(R.id.cll);
...
//        linearLayout.addView();
        ...
        View text2 = ctv.normalText(getString(R.string.steps_cll), container.getContext());
        linearLayout.addView(subHead2);
        linearLayout.addView(text2);


        View subHead3 = ctv.subHead(getString(R.string.ins_beg), container.getContext());
        View text3 = ctv.normalText(getString(R.string.ins_beg_cll), container.getContext());
//        CodeView codeView1 = new CodeView(container.getContext());
//        codeView1.setCode(getString(R.string.ll_syn_17));
//        Objects.requireNonNull(codeView1.getOptions()).withTheme(ColorTheme.MONOKAI);

        View codeView1 = ccv.Code(container.getContext(), c.ll16);
        ...
        View text4 = ctv.normalText(getString(R.string.ins_end_cll), container.getContext());
//        CodeView codeView2 = new CodeView(container.getContext());
//        codeView2.setCode(getString(R.string.ll_syn_18));
//        Objects.requireNonNull(codeView2.getOptions()).withTheme(ColorTheme.MONOKAI);
        View codeView2 = ccv.Code(container.getContext(), c.ll17);
        ...
        View text5 = ctv.normalText(getString(R.string.ins_spec_cll), container.getContext());
//        CodeView codeView3 = new CodeView(container.getContext());
//        codeView3.setCode(getString(R.string.ll_syn_19));
//        Objects.requireNonNull(codeView3.getOptions()).withTheme(ColorTheme.MONOKAI);
        View codeView3 = ccv.Code(container.getContext(), c.ll18);
        ...
        View text6 = ctv.normalText(getString(R.string.del_beg_cll), container.getContext());
//        CodeView codeView4 = new CodeView(container.getContext());
//        codeView4.setCode(getString(R.string.ll_syn_20));
//        Objects.requireNonNull(codeView4.getOptions()).withTheme(ColorTheme.MONOKAI);
        View codeView4 = ccv.Code(container.getContext(), c.ll19);
        ...
        View text7 = ctv.normalText(getString(R.string.ins_end_cll), container.getContext());
//        CodeView codeView5 = new CodeView(container.getContext());
//        codeView5.setCode(getString(R.string.ll_syn_21));
//        Objects.requireNonNull(codeView5.getOptions()).withTheme(ColorTheme.MONOKAI);
        View codeView5 = ccv.Code(container.getContext(), c.ll20);
        ...
        View text8 = ctv.normalText(getString(R.string.del_spec_cll), container.getContext());
//        CodeView codeView6 = new CodeView(container.getContext());
//        codeView6.setCode(getString(R.string.ll_syn_22));
//        Objects.requireNonNull(codeView6.getOptions()).withTheme(ColorTheme.MONOKAI);

        View codeView6 = ccv.Code(container.getContext(), c.ll21);
...
//        codeView7.setCode(getString(R.string.ll_syn_23));
//        Objects.requireNonNull(codeView7.getOptions()).withTheme(ColorTheme.MONOKAI);

        View codeView7 = ccv.Code(container.getContext(), c.ll22);
